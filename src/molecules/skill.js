		...
		return html`
			<div id="skill" aria-label="${name}" tabindex="0" class="${completed ? `completed` : ``}" @click="${this.toggleForceShowDescription}" @mouseenter="${this.onMouseEnter}" @mouseleave="${this.onMouseLeave}">
				<div id="img-container">
					<img id="img" loading="lazy" draggable="false" width="70px" height="70px" style="border:2px solid black;border-radius:15px" intrinsicsize="70x70" alt="${name}" role="presentation" data-src="${constructImagePathPrefix(collection, area, skill)}" />
				</div>
				<h6 id="title">${name}</h6>
